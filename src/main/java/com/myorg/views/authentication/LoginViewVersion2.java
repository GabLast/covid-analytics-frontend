...
@AnonymousAllowed
@Route(value = "login")
public class LoginViewVersion2 extends Div implements BeforeEnterObserver, HasDynamicTitle {
    ...
    public LoginViewVersion2(AppInfo appInfo, AuthenticatedUser authenticatedUser,
